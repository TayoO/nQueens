...
//********************************************************************************************************************
 ...
 //********************************************************************************************************************
    public static void main(String[] args) {
        for (int i = 0; i < 11; i++) {
            Individual queen = new Individual(10); 
            ...
            Individual i1 = new Individual(10); // For the cross over 3rd bracket
            Individual i2 = new Individual(10); // For the cross over 3RD bracket
